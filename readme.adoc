...
what do I. mean by Day 0 installation of OCP? - **I mean the things required to make the basic installation of OCP work.**, we will cover day 1 operations later in this guide and day 2 operations can be foud nat teh following repo <insert day 2 repo link here>


## So, am I an edge case? - THE QUESTIONS YOU NEED TO ASK.
